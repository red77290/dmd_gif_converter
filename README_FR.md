...
**"Let Me Handle It"** est le mode zéro-config ultime. Lorsqu'il est activé, il active les cinq systèmes IA simultanément et grise tous les réglages dont vous n'avez pas besoin — ne laissant que les contrôles qui restent pertinents :
...
Let Me Handle It ✓
    ...
    ├── 👁️ DMD Visibility Score       ← auto-activé (ON)
    │
...
> **Restauration :** désactiver le toggle restaure les cinq flags à leur état d'avant l'activation de "Let Me Handle It".
...
- Active 5 systèmes IA : Smart Color Boost + Auto Action + Smart Auto Crop + Soustraction de fond + DMD Visibility Score
