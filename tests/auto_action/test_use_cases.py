        ...
        if "platformer" in filename:
            ...
            if len(rois_y) > 10:
                ...
                if roi_var > 10.0:
                    ...
                    self.assertLess(cam_var, roi_var * 4.0, f"Camera Y variance ({cam_var:.1f}) is more than 4.0x ROI Y variance ({roi_var:.1f}). Floor estimator/head protection is too jittery.")
